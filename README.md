...
الإصدار الحالي: **1.1.1** — يتضمن إصلاحات ترجمة Kotlin وواجهات Compose التي ظهرت في GitHub Actions.
...
لرفع النسخة المصححة إلى المستودع الحالي `omissi/harmonix-player` ومراقبة البناء وتنزيل APK، اتبع ملف `TERMUX_GITHUB_BUILD_AR.md` المرفق.
